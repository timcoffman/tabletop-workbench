...
public class GameStateAddRelationship extends GameStateRelationshipMutation {

	public GameStateAddRelationship(GameRole role, GameOperation.Type type, GameComponentRef<GamePartRelationshipType> relationshipType, GamePlace source,
	...
	public AbstractGameStateMutation inverted() {
		return new GameStateRemoveRelationship(m_role, m_type, m_relationshipType, m_source, m_destination);
	}
