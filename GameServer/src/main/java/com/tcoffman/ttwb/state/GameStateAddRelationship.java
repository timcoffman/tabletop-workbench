...
public class GameStateAddRelationship extends GameStateInvertibleMutation {
	...
	public GameStateAddRelationship(GameRole role, GameOperation.Type type, GameComponentRef<GamePartRelationshipType> relationshipType, GamePlace subject,
			GamePlace target) {
		super(role, type);
	...
	public GameStateMutation inverted() {
		return new GameStateRemoveRelationship(m_role, m_type, m_relationshipType, m_subject, m_target);
	}
}
